      ...
      <div className="home">
        ...
        <section>
          <header className="header-banner">
            ...
            <div className="animated-texts overlay-content">
              <h1>
                Welcome to <span className="phegon-color">WanderNest</span>
              </h1>
              <br />
        ...
        <RoomSearch
          ...
          onDatesChange={(start, end) =>
            setSelectedDates({ checkInDate: start, checkOutDate: end })
          }
        />
        <RoomResult
        ...
        <h2 className="home-services">
          Services at <span className="phegon-color">WanderNest</span>
        </h2>
