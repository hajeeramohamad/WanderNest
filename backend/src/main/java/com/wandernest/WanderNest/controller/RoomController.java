package com.wandernest.WanderNest.controller;
...
public class RoomController {
    ...
    // RoomController.java
    @GetMapping("/available-room-counts")
    public ResponseEntity<Response> getAvailableRoomCounts(
            @RequestParam("checkInDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate checkInDate,
            @RequestParam("checkOutDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate checkOutDate,
            @RequestParam("roomType") String roomType) {

        Response response = roomService.getAvailableRoomCountsByTypeAndDates(checkInDate, checkOutDate, roomType);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
